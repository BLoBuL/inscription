...
if (
	strpos($administration, "maj['4.1.2']") === false
	...
	|| strpos($administration, '$auteurs_avec_pays && $ancien_id !== $nouvel_id') === false
) {
	$erreurs[] = 'La migration 4.1.2 doit supprimer la table Pays obsolète même sans colonne auteurs.pays.';
}
if (
