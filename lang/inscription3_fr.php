...
// Fichier source, a modifier dans https://git.spip.net/spip-contrib-extensions/inscription.git
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_destinataire_supp_notifications' => 'Vous pouvez spécifier ici des destinataires supplémentaires (emails séparés par des virgules)',
	...
	'explication_password_reset' => 'Cocher pour afficher le bouton de reset de mot de passe à côté des champs mot de passe.',
	...
	'formulaire_inscription_ok' => 'Votre inscription a bien été prise en compte. Vous allez recevoir par courrier électronique un lien sécurisé pour valider votre compte et choisir votre mot de passe.',
	...
	'icone_configurer_inscription3' => 'Configurer Inscription 4',
	'info_aconfirmer' => 'à confirmer',
	'info_cextras_desc' => 'Les colonnes Formulaire et Obligatoire modifient directement la définition CExtras du champ. Les colonnes Fiche et Table restent des contextes d’affichage propres à Inscription 4.',
	...
	'label_destinataire_supp_notifications' => 'Destinataires supplémentaires',
	'label_email' => 'E-Mail :',
	'label_fax' => 'Fax :',
	...
	'label_password_reset' => 'Bouton de reset',
	...
	'message_auteur_inscription_confirmer_contenu_admin' => '@nom@ a demandé à avoir un compte sur le site. Vous pouvez valider ou invalider cette requête.',
	...
	'message_auteur_inscription_attente_contenu_admin' => '@nom@ a demandé la création d’un compte. Ce compte ne peut pas encore être utilisé. Validez la demande pour envoyer automatiquement à cette personne un lien sécurisé lui permettant de choisir son mot de passe, ou refusez-la.',
	'message_auteur_inscription_attente_contenu_user' => 'votre inscription a bien été enregistrée. Aucune action n’est nécessaire pour le moment. Un administrateur doit d’abord valider votre compte. Vous recevrez ensuite un lien sécurisé pour choisir votre mot de passe.',
	'message_auteur_inscription_attente_titre_admin' => '[@nom_site_spip@] Compte de @nom@ à valider',
	'message_auteur_inscription_attente_titre_user' => '[@nom_site_spip@] Inscription reçue — validation en attente',
	'message_auteur_inscription4_valider_contenu_user' => 'votre compte a été validé par un administrateur du site. Choisissez maintenant votre mot de passe à l’aide du lien sécurisé ci-dessous, puis connectez-vous pour activer votre compte.',
	'message_auteur_inscription4_valider_titre_user' => '[@nom_site_spip@] Votre compte a été validé — choisissez votre mot de passe',
	'message_auteur_inscription4_validation_lien' => 'Ce lien temporaire vous permet de définir votre mot de passe :',
	...
	'message_auteur_inscription_valider_contenu_user' => 'votre compte a été validé par un administrateur du site. Pour finaliser votre accès, choisissez maintenant votre mot de passe à l’aide du lien sécurisé ci-dessous.',
	'message_auteur_inscription_valider_titre_user' => '[@nom_site_spip@] Votre compte a été validé',
	'message_auteur_validation_lien' => 'Ce lien temporaire vous permet de définir votre mot de passe :',
