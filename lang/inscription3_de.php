...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'message_auteur_inscription_attente_contenu_admin' => '@nom@ hat ein Konto beantragt. Dieses Konto kann noch nicht verwendet werden. Genehmigen Sie den Antrag, um dieser Person automatisch einen sicheren Link zur Auswahl ihres Passworts zu senden, oder lehnen Sie ihn ab.',
	'message_auteur_inscription_attente_contenu_user' => 'Ihre Anmeldung wurde registriert. Sie müssen im Moment nichts weiter tun. Zunächst muss ein Administrator Ihr Konto genehmigen. Anschließend erhalten Sie einen sicheren Link, über den Sie Ihr Passwort festlegen können.',
	'message_auteur_inscription_attente_titre_admin' => '[@nom_site_spip@] Konto von @nom@ wartet auf Genehmigung',
	'message_auteur_inscription_attente_titre_user' => '[@nom_site_spip@] Anmeldung eingegangen — Genehmigung ausstehend',
	'message_auteur_inscription4_valider_contenu_user' => 'Ihr Konto wurde von einem Administrator genehmigt. Legen Sie über den folgenden sicheren Link Ihr Passwort fest und melden Sie sich anschließend an, um Ihr Konto zu aktivieren.',
	'message_auteur_inscription4_valider_titre_user' => '[@nom_site_spip@] Ihr Konto wurde genehmigt — Passwort festlegen',
	'message_auteur_inscription4_validation_lien' => 'Verwenden Sie diesen temporären sicheren Link, um Ihr Passwort festzulegen:',
	'message_auteur_inscription_pass' => 'Ihr Konto wurde angelegt. Sie haben Ihr Passwort selbst gewählt.',
	'message_auteur_inscription_valider_contenu_user' => 'Ihr Konto wurde von einem Administrator genehmigt. Um den Zugang abzuschließen, legen Sie jetzt über den folgenden sicheren Link Ihr Passwort fest.',
	'message_auteur_inscription_valider_titre_user' => '[@nom_site_spip@] Ihr Konto wurde genehmigt',
...
',
	...
	'message_auteur_validation_lien' => 'Verwenden Sie diesen temporären sicheren Link, um Ihr Passwort festzulegen:',
