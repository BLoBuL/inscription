...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_cextras_desc' => 'De kolommen Formulier en Verplicht wijzigen rechtstreeks de CExtras-definitie van het veld. De kolommen Profiel en Tabel blijven weergavecontexten van Inscription 4.',
	...
	'message_auteur_inscription_confirmer_contenu_admin' => '@nom@ heeft een account op de site aangevraagd. U kunt dit verzoek goedkeuren of afwijzen.',
	'message_auteur_inscription_confirmer_contenu_user' => 'uw account wacht momenteel op validatie van een sitebeheerder.',
	'message_auteur_inscription_confirmer_titre_admin' => '[@nom_site_spip@] Verzoek om het account van @nom@ goed te keuren',
	'message_auteur_inscription_confirmer_titre_user' => '[@nom_site_spip@] Uw account wacht op goedkeuring',
	'message_auteur_inscription_attente_contenu_admin' => '@nom@ heeft een account aangevraagd. Dit account kan nog niet worden gebruikt. Keur het verzoek goed om deze persoon automatisch een beveiligde link te sturen waarmee een wachtwoord kan worden gekozen, of wijs het verzoek af.',
	'message_auteur_inscription_attente_contenu_user' => 'uw registratie is ontvangen. U hoeft voorlopig niets te doen. Een beheerder moet uw account eerst goedkeuren. Daarna ontvangt u een beveiligde link waarmee u uw wachtwoord kunt kiezen.',
	'message_auteur_inscription_attente_titre_admin' => '[@nom_site_spip@] Account van @nom@ wacht op goedkeuring',
	'message_auteur_inscription_attente_titre_user' => '[@nom_site_spip@] Registratie ontvangen — goedkeuring in afwachting',
	'message_auteur_inscription4_valider_contenu_user' => 'Uw account is door een beheerder goedgekeurd. Stel via de onderstaande beveiligde link uw wachtwoord in en meld u daarna aan om uw account te activeren.',
	'message_auteur_inscription4_valider_titre_user' => '[@nom_site_spip@] Uw account is goedgekeurd — stel uw wachtwoord in',
	'message_auteur_inscription4_validation_lien' => 'Gebruik deze tijdelijke beveiligde link om uw wachtwoord in te stellen:',
...
',
	...
	'message_auteur_validation_lien' => 'Gebruik deze tijdelijke beveiligde link om uw wachtwoord in te stellen:',
